...
public class PreferencesPanel extends JFrame implements ActionListener {
    ...
    public JPanel createLevelPane() {
        levelSlider = new JSlider(JSlider.HORIZONTAL,1,5,1);
        JPanel levelPane = new JPanel();        
        levelSlider.setMajorTickSpacing(1);
        levelSlider.setPaintTicks(true);
        levelSlider.setPaintLabels(true);
        levelPane.add(levelSlider);
        levelPane.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(5,0,0,5),BorderFactory.createTitledBorder("Difficulty Level")));
        return levelPane;
    }
    public JPanel createColorPane() {
        ...
        colorPane.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(5,0,0,5),BorderFactory.createTitledBorder("Color of pieces")));
        return colorPane;
    }
